...
export const AdminProjects = ({ projects, setProjects, S, showToast }) => {
  const blank = {
    id: "",
    title: "",
  ...
  return (
    <div>
      ...
      >
        <h2 style={{ ...S.sectionTitle, margin: 0, border: "none", padding: 0 }}>
          Portfolio Projects
        </h2>
        <button
          data-hover
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            <div>
              ...
              <input
                ...
                style={S.input}
                placeholder="Identity, Packaging, Typography"
              />
            </div>
            <div>
              ...
              <div style={{ display: "flex", gap: "0.75rem", alignItems: "center", marginBottom: "1.2rem" }}>
                <input
                  type="color"
                  value={form.color}
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "0.25rem" }}>
                <span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1rem", color: "rgba(245,240,232,0.75)" }}>
                  {p.title}
                </span>
                {p.featured && (
                  <span
